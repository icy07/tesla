    ...
    (() => {
        ...
        let formValidate = {
            ...
            validateInput(formRequiredItem) {
                let error = 0;
                let exp = /\+7\s\d\d\d\s\d\d\d\s\d\d\s\d\d/;
        ...
        function initSliders() {
            bildSliders();
            if (document.querySelector(".swiper")) new core(".reviews__slider", {
        ...
        function windowLoad() {
            function digitsCountersInit(digitsCounterItems) {
                let digitsCounters = digitsCounterItems ? digitsCounterItems : document.querySelectorAll("[data-counter]");
            ...
            function digitsCountersAnimate(digitsCounter) {
                ...
                const duration = parseInt(digitsCounter.dataset.counter) ? parseInt(digitsCounter.dataset.counter) : 1e3;
            ...
            let observer = new IntersectionObserver(((entries, observer) => {
                entries.forEach((entry => {
                    if (entry.isIntersecting) {
                        ...
                        if (digitsCounterItems.length) digitsCountersInit(digitsCounterItems);
                    }
                }));
            }), options);
